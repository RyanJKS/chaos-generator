...
Follow the setup steps in [README.md](README.md), including `uv run pre-commit install`.

1. Create a branch from `main` with a descriptive name.
2. Keep changes focused and add tests for new behavior when applicable.
3. Run the formatting, test, and compilation checks listed in the README.
